...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. Sparkleunity can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    QString splashImage = ":/images/splash";
    if(GetBoolArg("-testnet"))
    splashImage = ":/images/splash-testnet";

    QSplashScreen splash(QPixmap(splashImage), 0);

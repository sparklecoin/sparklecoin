...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SCTK");
    case mBTC: return QString("mSCTK");
    case uBTC: return QString::fromUtf8("μSCTK");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Sparklecoins");
    case mBTC: return QString("Milli-Sparklecoins (1 / 1,000)");
    case uBTC: return QString("Micro-Sparklecoins (1 / 1,000,000)");
    default: return QString("???");
    }
}

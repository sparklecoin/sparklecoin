 ...
 * The SPKLoin Developers 2011-2013
 */
...
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/sparkleunity_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Sparklecoin address"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/sparkleunity_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/sparkleunity_icon"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sparklecoin network", "", count));
}

...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 19080, uint256("00000000000000afe37b4935607631decac4bf3fb0e008f9bb700d073a6d868e" ))
        ( 30583, uint256("00000000000000b6a1c931d793d07ec77fbf8da6c280c092bfaddf04412cfaa3" ))
        ;
    ...
    // sparklecoin: synchronized checkpoint (centrally broadcasted)
    ...
    // sparklecoin: get last synchronized checkpoint
    ...
    // sparklecoin: only descendant of current sync-checkpoint is allowed
    ...
    // sparklecoin: reset synchronized checkpoint to last hardened checkpoint
...
// sparklecoin: verify signature of sync-checkpoint message
...
// sparklecoin: process synchronized checkpoint

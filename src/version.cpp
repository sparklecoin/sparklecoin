...
#ifndef BUILD_DESC
#    ifdef GIT_COMMIT_ID
#        define BUILD_DESC BUILD_DESC_FROM_COMMIT(SPARKLEUNITY_VERSION_MAJOR, SPARKLEUNITY_VERSION_MINOR, SPARKLEUNITY_VERSION_REVISION, SPARKLEUNITY_VERSION_BUILD, GIT_COMMIT_ID)
#    else
#        define BUILD_DESC BUILD_DESC_FROM_UNKNOWN(SPARKLEUNITY_VERSION_MAJOR, SPARKLEUNITY_VERSION_MINOR, SPARKLEUNITY_VERSION_REVISION, SPARKLEUNITY_VERSION_BUILD)
#    endif
#endif

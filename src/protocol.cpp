...
static unsigned char pchMessageStartTestOld[4] = { 0xdb, 0xd2, 0xef, 0xfc };
static unsigned char pchMessageStartTestNew[4] = { 0xcf, 0xfd, 0xb0, 0xca };
static unsigned int nMessageStartTestSwitchTime = 1346200000;

// SparkleCoin message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xe4, 0xe7, 0xc6, 0xd2 };
static unsigned char pchMessageStartSparklecoin[4] = { 0xe3, 0xe4, 0xe8, 0xe2 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartSparklecoin : pchMessageStartBitcoin, sizeof(pchMessageStartSparklecoin));
}

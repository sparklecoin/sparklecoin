...
static const int COINBASE_MATURITY_SPRK = 288; // two days
...
static const unsigned int GENESIS_BLOCK_REWARD = 59187500; 
...
static const uint256 hashGenesisBlockOfficial("0x00000000e7a2418a21c3b3042794cef19d88b9587ebff903f3b6b204940113a3");
static const uint256 hashGenesisBlockTestNet("0x000001e1f591971418cffb1aafec59d2b527f6a459c624a197846574ca213b68");
...
public:
    ...
    {
        // sparklecoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // sparklecoin: get transaction coin age
...
public:
    ...
    // sparklecoin: block signature - signed by coin base txout[0]'s owner
    ...
    // sparklecoin: two types of block: proof-of-work or proof-of-stake
    ...
    // sparklecoin: get max transaction timestamp
    ...
    bool CheckBlock(int64 nBlockHeight=-1) const;
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // sparklecoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // sparklecoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // sparklecoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // sparklecoin: block index flags
    enum  
    {
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("0421c98a2956fca7570dc1ccb2b5e672c587b08768184f61d737ff7ec26d59f7b2addded9153d652a46db174e039a92b7debef06415b8fc5e94442750db63f5b3e")))

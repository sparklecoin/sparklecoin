...
#else
    const char* pszModule = "sparklecoin";
#endif
    if (pex)
...
boost::filesystem::path GetConfigFile()
{
    ...
    fs::path pathConfigFile(GetArg("-conf", "sparklecoin.conf"));
...
boost::filesystem::path GetPidFile()
{
    ...
    fs::path pathPidFile(GetArg("-pid", "sparklecoind.pid"));
...
{
    return GetAutostartDir() / "sparklecoin.desktop";
}

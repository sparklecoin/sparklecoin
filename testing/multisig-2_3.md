...
Alice sends 360 SCTK to the multisig address.
...
The transaction will have 360 SCTK (Alice's coins) as input and 359.99 SCTK as output (because of the mandatory 0.01 SCTK transaction fee; the transaction won't be accepted by the network without it).

...
* test1  mkLh7wYGYQiKVm8tLwCs9LusKF2y1gffm9  8.01SPKL 
* test2  n2LzA1UH46QZPdCGvN2NorPeqg1BbTuw4g  2SPKL
* test3  mpRAV4VSsxmKh5nRpDuQPquhdHPKu4xUuS  7SPKL
...
* Send 1 SPKL from test2 to test1 to 1) create change 2) create two outputs in test1.  
  Results: test2 has 0.99SPKL left and test1 has 9.01SPKL, as shown by coin control window. (A strict verification can be done using a block explorer. txid 94686d535fae9fc015b7e3a270123f437066c60f3c63b658774ffb60e530ee3a )  
  This confirms:
...
* Send 5 SPKL from test1 to test2 using test3 as the custom change address.  
  Results: test1 has 1 SPKL test2 has 5.99 SPKL test3 has 10 SPKL, as expected. The custom change address function is verified. txid eed4baecbcaedcf442647103fc8a18812dce2b4c852ee447b473f157c41cb837
...
Low Output is yes when the amount is less than 0.01 SPKL.
